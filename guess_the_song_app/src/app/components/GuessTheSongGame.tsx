        ...
        <div className="flex flex-col items-end gap-2">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/5 text-sm font-semibold hover:bg-white/10"
          ...
          <Card className="w-full max-w-lg space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <div className="text-xs text-white/60">Daily rules, free play, and scoring.</div>
              </div>
            ...
            <div className="space-y-3 text-sm text-white/80">
              <div>
                <div className="font-semibold text-white/90">Daily mode</div>
                <div>Guess 5 songs for the day. Hints do not reduce your score.</div>
              </div>
              <div>
                <div className="font-semibold text-white/90">Free play</div>
                <div>
                  Unlocks after finishing today’s set and acknowledging the leaderboard (submit or skip). Songs are shuffled
                  per session and exclude the daily set.
                </div>
              </div>
              <div>
                <div className="font-semibold text-white/90">Scoring</div>
                ...
                <div className="mt-2 text-xs text-white/60">Each bonus question is worth +10 points.</div>
                <div className="text-xs text-white/60">Bonus points still count if you give up on the song.</div>
              </div>
            </div>
          </Card>
        </div>
